...
mkordtmpf.starttime  mkordtmpf_starttime
 from mkordtmpfs   mkordtmpf,
  r_persons  person_upd ,  r_itms  itm ,  r_locas  loca ,  r_prjnos  prjno ,  r_itms  itm_pare ,  r_shelfnos  shelfno_to ,  r_mkprdpurords  mkprdpurord ,  r_shelfnos  shelfno_to_pare 
  where       mkordtmpf.persons_id_upd = person_upd.id      and mkordtmpf.itms_id = itm.id      and mkordtmpf.locas_id = loca.id      and mkordtmpf.prjnos_id = prjno.id      and mkordtmpf.itms_id_pare = itm_pare.id      and mkordtmpf.shelfnos_id_to = shelfno_to.id      and mkordtmpf.mkprdpurords_id = mkprdpurord.id      and mkordtmpf.shelfnos_id_to_pare = shelfno_to_pare.id     ;
