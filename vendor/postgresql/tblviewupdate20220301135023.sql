...
custinst.custrcvplcs_id   custinst_custrcvplc_id,
  ...
  cust.person_name_chrg_cust  person_name_chrg_cust ,
  cust.person_sect_id_chrg_cust  person_sect_id_chrg_cust ,
  chrg_custord.chrg_person_id_chrg  chrg_person_id_chrg_custord ,
...
custinst.opeitms_id   custinst_opeitm_id,
  opeitm.loca_code_opeitm  loca_code_opeitm ,
  opeitm.loca_name_opeitm  loca_name_opeitm ,
custinst.chrgs_id_custord   custinst_chrg_id_custord,
  opeitm.shelfno_code_fm_opeitm  shelfno_code_fm_opeitm ,
  opeitm.shelfno_name_fm_opeitm  shelfno_name_fm_opeitm ,
  opeitm.shelfno_loca_id_shelfno_fm_opeitm  shelfno_loca_id_shelfno_fm_opeitm ,
  opeitm.loca_code_shelfno_fm_opeitm  loca_code_shelfno_fm_opeitm ,
...
custinst.cno_custord  custinst_cno_custord
 from custinsts   custinst,
  r_persons  person_upd ,  r_custs  cust ,  r_custrcvplcs  custrcvplc ,  r_shelfnos  shelfno_fm ,  r_opeitms  opeitm ,  r_chrgs  chrg_custord 
  where       custinst.persons_id_upd = person_upd.id      and custinst.custs_id = cust.id      and custinst.custrcvplcs_id = custrcvplc.id      and custinst.shelfnos_id_fm = shelfno_fm.id      and custinst.opeitms_id = opeitm.id      and custinst.chrgs_id_custord = chrg_custord.id     ;
...
,custinst_chrg_id_custord  numeric (38,0)
...
,opeitm_boxe_id  numeric (22,0)
,bill_loca_id_bill  numeric (38,0)
,chrg_person_id_chrg_custord  numeric (38,0)
,person_sect_id_chrg_cust  numeric (22,0)
,shelfno_loca_id_shelfno_fm_opeitm  numeric (38,0)
...
custact.opeitms_id   custact_opeitm_id,
  opeitm.loca_code_opeitm  loca_code_opeitm ,
  opeitm.loca_name_opeitm  loca_name_opeitm ,
custact.chrgs_id_custord   custact_chrg_id_custord,
  opeitm.shelfno_code_fm_opeitm  shelfno_code_fm_opeitm ,
  opeitm.shelfno_name_fm_opeitm  shelfno_name_fm_opeitm ,
  opeitm.shelfno_loca_id_shelfno_fm_opeitm  shelfno_loca_id_shelfno_fm_opeitm ,
  opeitm.loca_code_shelfno_fm_opeitm  loca_code_shelfno_fm_opeitm ,
...
custact.cartonno  custact_cartonno
 from custacts   custact,
  r_custrcvplcs  custrcvplc ,  r_persons  person_upd ,  r_custs  cust ,  r_shelfnos  shelfno_fm ,  r_opeitms  opeitm ,  r_chrgs  chrg_custord 
  where       custact.custrcvplcs_id = custrcvplc.id      and custact.persons_id_upd = person_upd.id      and custact.custs_id = cust.id      and custact.shelfnos_id_fm = shelfno_fm.id      and custact.opeitms_id = opeitm.id      and custact.chrgs_id_custord = chrg_custord.id     ;
...
,cust_crr_id_cust  numeric (38,0)
,opeitm_priority  numeric (3,0)
,custact_chrg_id_custord  numeric (38,0)
