...
AS SELECT chrg.person_name_chrg,
    ...
    func_get_free_stk(shpord.itms_id ,shpord.processseq ) as forInstsShpord_qty_stk_free,
    ...
    shpord.contract_price AS shpord_contract_price,
...
CREATE TABLE sio.sio_forinsts_shpords (
	...
	shpord_tax numeric(38, 4) NULL,
	shpord_contract_price varchar(1) NULL,
	...
	crr_pricedecimal numeric(22) NULL,
